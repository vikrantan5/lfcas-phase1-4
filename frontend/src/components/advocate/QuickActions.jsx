  ...
  const actions = [
    {
      ...
      label: 'Add New Case',
      badge: null,
      action: () => navigate('/advocate/cases/new'),
    },
    {
      icon: Clock,
      iconBg: '#EDE7F6',
      ...
      badge: 4,
      action: () => navigate('/advocate/requests'),
    },
    {
      icon: FolderOpen,
      iconBg: '#FFF3E0',
      ...
      badge: null,
      action: () => navigate('/advocate/documents'),  // ✅ This is already correct
    },
    {
      icon: DollarSign,
      iconBg: '#E8F5E9',
      ...
      badge: null,
      action: () => navigate('/advocate/payments'),
    },
  ];
    ...
    >
      {actions.map((action) => (
        <button
          ...
          onClick={action.action}  // ✅ Add the onClick handler here
        >
